...
def train():
    ...
    if (
            model_args.model_type == 'phi-1.5' or model_args.model_type == 'phi-2' or model_args.model_type == 'phi-3' \
            or model_args.model_type == 'qwen1.5-1.8b'
            or model_args.model_type == 'gemma' or model_args.model_type == 'minicpm' or model_args.model_type == 'llama3-8b'):
    ...
    elif model_args.model_type == 'aquila':
    ...
    if model_args.model_type == 'phi-1.5' or model_args.model_type == 'phi-2':
       ...
       model = BunnyAquilaForCausalLM.from_pretrained(
            model_args.model_name_or_path,
            cache_dir=training_args.cache_dir,
            **bnb_model_from_pretrained_args
        )
