...
2. The [script](https://github.com/BAAI-DCAI/SpatialBot/blob/main/script/eval/lora/spatial_bench.sh) uses RGBD by default. To test with RGB, comment out ```--depth``` in it.
```shell
